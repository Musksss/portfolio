<div style="display: flex; flex-direction: row;">
  ...
  <div style="flex: 1; padding-right: 20px;">
    <img src="path-to-your-photo.jpg" alt="Your Name" style="width: 200px; height: auto;"/>
  </div>
...
**Technical Business Analyst @ Statiq (_November 2021 - August 2023_)**
...
This project is focused on improving our ability to predict the onset of diabetes by examining the intricate relationship between demographics, medical problems, and lifestyle decisions. The goal of the project is to create a prediction model to identify individuals at risk of developing diabetes. Advanced statistical methods, including **logistic regression**, **random forest**, and **gradient boosting** models, are utilized. Meanwhile, the prediction model is developed using comprehensive datasets containing diverse demographic variables, medical histories, and lifestyle data. The objective is to deploy the model to assist healthcare providers and patients in identifying high-risk individuals for early intervention.

## Skills
- **Languages**: Python, R, SQL, JavaScript, HTML/CSS
- **Libraries/Tools**: Pandas, NumPy, Scikit-learn, Matplotlib, Seaborn, TensorFlow, PyTorch, spaCy, TextBlob, CountVectorizer
- **Databases**: PostgreSQL, MySQL, MongoDB, SQL Server
- **Technologies**: AWS, Azure, Git, GitHub, Tableau, Power BI, Power Automate, Zapier, Flask
- **Techniques**: Machine Learning, NLP, Statistical Analysis, Predictive Modeling, Data Visualization, SQL Querying
